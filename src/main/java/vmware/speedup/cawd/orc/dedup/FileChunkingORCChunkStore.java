...
public class FileChunkingORCChunkStore extends ColumnarChunkStore<FileChunkingORCChunkingAlgorithm.ORCFileChunk, FileChunkingORCChunkingAlgorithm>{

	private Map<ORCFileChunk, ORCFileChunk> chunkStore = new HashMap<ORCFileChunk, ORCFileChunk>();
	
	@Override
	public List<ORCFileChunk> addChunks(byte[] data, FileChunkingORCChunkingAlgorithm algorithm) throws NoSuchAlgorithmException {
