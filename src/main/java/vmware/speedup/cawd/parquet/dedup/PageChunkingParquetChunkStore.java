...
public class PageChunkingParquetChunkStore extends ColumnarChunkStore<PageChunkingParquetChunkingAlgorithm.ParquetFileChunk, PageChunkingParquetChunkingAlgorithm>{

	private Map<ParquetFileChunk, ParquetFileChunk> chunkStore = new HashMap<ParquetFileChunk, ParquetFileChunk>();
	
	@Override
	public List<ParquetFileChunk> addChunks(byte[] data, PageChunkingParquetChunkingAlgorithm algorithm) throws NoSuchAlgorithmException {
