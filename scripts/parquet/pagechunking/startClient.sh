...
PROPS="-Dcawd.client.input=/home/administrator/dedup-data/tpcds.all.parquet/ $PROPS"
PROPS="-Dcawd.client.filters=.parquet $PROPS"
PROPS="-Dcawd.streamer.type=vmware.speedup.cawd.parquet.net.PageChunkingParquetStreamer $PROPS"
## log file...
