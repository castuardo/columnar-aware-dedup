...
PROPS="-Dcawd.client.input=/home/ubuntu/dedup-data/uncompressed/orc/coalesce/mixres_pure $PROPS"
PROPS="-Dcawd.client.filters=.orc $PROPS"
PROPS="-Dcawd.streamer.type=vmware.speedup.cawd.orc.net.PageChunkingORCStreamer $PROPS"
## log file...
